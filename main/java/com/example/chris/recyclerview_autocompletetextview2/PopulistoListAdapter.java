 ...
 */
public class PopulistoListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PopulistoListAdapter(List<Review> reviews, Activity activity) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        ((ReviewHolder) viewHolder).itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Review review = (Review) PopulistoListAdapter.getItem(position);
